...
#include <stddef.h>
#include "blas.h"
#include "task_3f_sfun.h"
#include "c2_task_3f.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "task_3f_sfun_debug_macros.h"
...
static void initialize_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void initialize_params_c2_task_3f(SFc2_task_3fInstanceStruct
  *chartInstance);
static void enable_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void disable_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_task_3f(SFc2_task_3fInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_task_3f(SFc2_task_3fInstanceStruct
  *chartInstance);
static void set_sim_state_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void sf_gateway_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void mdl_start_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_chartstep_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void initSimStructsc2_task_3f(SFc2_task_3fInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance, const
  mxArray *c2_b_P_dot, const char_T *c2_identifier, real_T c2_b_y[16]);
static void c2_b_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[16]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
  const mxArray *c2_b_x_hat_dot, const char_T *c2_identifier, real_T c2_b_y[4]);
static void c2_d_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_f_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
...
static void c2_eml_scalar_eg(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_threshold(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_e_eml_scalar_eg(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_f_eml_scalar_eg(SFc2_task_3fInstanceStruct *chartInstance);
static void c2_g_eml_scalar_eg(SFc2_task_3fInstanceStruct *chartInstance);
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_h_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_task_3f, const char_T *c2_identifier);
static uint8_T c2_i_emlrt_marshallIn(SFc2_task_3fInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_task_3fInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_task_3fInstanceStruct *chartInstance);
...
static void initialize_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_task_3f = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_task_3f;
  ...
  const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_task_3f = c2_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_b_u, 2)), "is_active_c2_task_3f");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_task_3f(chartInstance);
...
static void sf_gateway_c2_task_3f(SFc2_task_3fInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_task_3f(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_task_3fMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_b_u[16];
  const mxArray *c2_b_y = NULL;
  SFc2_task_3fInstanceStruct *chartInstance;
  chartInstance = (SFc2_task_3fInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_task_3f_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_task_3f, const char_T *c2_identifier)
{
  ...
  c2_b_y = c2_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_task_3f), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_task_3f);
  return c2_b_y;
}
...
void sf_c2_task_3f_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_task_3f_get_post_codegen_info(void);
mxArray *sf_c2_task_3f_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_task_3f_get_post_codegen_info();
...
mxArray *sf_c2_task_3f_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_task_3f_jit_fallback_info(void)
{
...
mxArray *sf_c2_task_3f_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_task_3f(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"P_dot\",},{M[1],M[7],T\"x_hat_dot\",},{M[8],M[0],T\"is_active_c2_task_3f\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_task_3f_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_task_3fInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_task_3fMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_task_3fMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _task_3fMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c2_task_3f(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_task_3fInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c2_task_3f((SFc2_task_3fInstanceStruct*) chartInstanceVar);
  initialize_c2_task_3f((SFc2_task_3fInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_task_3f(void *chartInstanceVar)
{
  enable_c2_task_3f((SFc2_task_3fInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_task_3f(void *chartInstanceVar)
{
  disable_c2_task_3f((SFc2_task_3fInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_task_3f(void *chartInstanceVar)
{
  sf_gateway_c2_task_3f((SFc2_task_3fInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_task_3f(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_task_3f((SFc2_task_3fInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_task_3f(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_task_3f((SFc2_task_3fInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c2_task_3f(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_task_3fInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_task_3f_optimization_info();
    }

    finalize_c2_task_3f((SFc2_task_3fInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_task_3f((SFc2_task_3fInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_task_3f(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_task_3f((SFc2_task_3fInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_task_3f(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_task_3f_optimization_info();
...
static void mdlRTW_c2_task_3f(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_task_3f(SimStruct *S)
{
  SFc2_task_3fInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_task_3fInstanceStruct *)utMalloc(sizeof
    (SFc2_task_3fInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_task_3fInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_task_3f;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_task_3f;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_task_3f;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_task_3f;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_task_3f;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_task_3f;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_task_3f;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_task_3f;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_task_3f;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_task_3f;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_task_3f;
...
void c2_task_3f_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_task_3f(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_task_3f(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_task_3f(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_task_3f_method_dispatcher.\n"
