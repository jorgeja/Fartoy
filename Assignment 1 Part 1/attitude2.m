...
clf
figure(gcf)
subplot(221),plot(t,phi,t,theta,t,psi,'linewidth',1),xlabel('time (s)'),ylabel('deg'),title('attitude'),grid,legend('\phi', '\theta', '\psi')
subplot(222),plot(t,phi_e,t,theta_e,t,psi_e,'linewidth',1),xlabel('time (s)'),ylabel('deg'),title('tracking error'),grid,legend('\phi error', '\theta error', '\psi error')
subplot(223),plot(t,w,'linewidth',1),xlabel('time (s)'),ylabel('deg/s'),title('w'),grid,legend('p', 'q', 'r')
subplot(224),plot(t,tau,'linewidth',1),xlabel('time (s)'),ylabel('Nm'),title('\tau'),grid,legend('K', 'M', 'N')